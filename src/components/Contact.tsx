...
const contactInfo = [
  ...
  { icon: Phone, title: "Telepon", content: "+62 851-5665-5145", link: "tel:+6285156655145" },
  { icon: Mail, title: "Email", content: "info@mandiritehnikhade.com", link: "mailto:info@mandiritehnikhade.com" },
];
          ...
          <div className="space-y-8">
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1 text-card-foreground">{info.title}</h3>
                  {info.link ? (
                    <a
                      href={info.link}
